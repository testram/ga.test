...
namespace GameAffinity\CategoriaBundle\Tests\Controller;
...
class CategoriaControllerTest extends WebTestCase
{
    ...
    public function testCompleteScenario()
    {
        ...
        $form = $crawler->selectButton('Create')->form(array(
            'gameaffinity_categoriabundle_categoriatype[field_name]'  => 'Test',
        ...
        $form = $crawler->selectButton('Edit')->form(array(
            'gameaffinity_categoriabundle_categoriatype[field_name]'  => 'Foo',
            // ... other fields to fill
        ));
