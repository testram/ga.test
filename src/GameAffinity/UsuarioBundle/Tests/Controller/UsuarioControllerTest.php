...
namespace GameAffinity\UsuarioBundle\Tests\Controller;
...
class UsuarioControllerTest extends WebTestCase
{
    ...
    public function testCompleteScenario()
    {
        ...
        $form = $crawler->selectButton('Create')->form(array(
            'gameaffinity_usuariobundle_usuariotype[field_name]'  => 'Test',
        ...
        $form = $crawler->selectButton('Edit')->form(array(
            'gameaffinity_usuariobundle_usuariotype[field_name]'  => 'Foo',
            // ... other fields to fill
        ));
